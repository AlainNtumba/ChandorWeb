...
public sealed class ChandorApiOptions
{
    ...
    /// <summary>
    /// Root URL including the <c>/api/</c> segment (e.g. http://192.168.11.104:5227/api/ https://localhost:7145/api/).
    /// </summary>
    public string BaseUrl { get; set; } = "http://192.168.11.104:5227/api/";
